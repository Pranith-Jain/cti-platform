...
export const CATALOG: TelegramEntry[] = [
  ...
  },
  {
    ...
    attribution: 'Brad Duncan (malware-traffic-analysis.net)',
    categories: ['malware-research', 'threat-intel'],
    language: 'en',
    audience: 'public-channel',
    description:
      'Companion channel to malware-traffic-analysis.net — daily PCAPs, IOC bundles, and campaign write-ups for in-the-wild commodity malware.',
    badge: 'research',
  },
  {
    id: 'ransomwatch',
    name: 'RansomWatch (mirror)',
    handle: 'ransomwatch',
    attribution: 'mirrors ransomwatch.telemetry.ltd',
    categories: ['ransomware', 'threat-intel'],
    language: 'en',
    audience: 'public-channel',
    description:
      'Aggregates ransomware leak-site postings across 60+ tracked groups. Useful as a real-time alerting feed for new victim claims; complement /dfir/onion-watch for actual mirror reachability.',
  },
  {
    id: 'cyberknow',
    name: 'CyberKnow',
    handle: 'CyberKnow20',
    attribution: 'CyberKnow OSINT',
    categories: ['threat-intel', 'hacktivism'],
    language: 'en',
    audience: 'public-channel',
    description:
      'Hacktivist-collective tracking — daily posts on pro-Russia / pro-Ukraine / pro-Palestine cyber-ops and dump claims. Strong cross-conflict coverage.',
    badge: 'research',
  },
  {
    id: 'falconfeeds',
    ...
    attribution: 'FalconFeeds (Cyfirma adjacent)',
    categories: ['threat-intel', 'ransomware', 'breach-leaks'],
    language: 'en',
    audience: 'public-channel',
    description:
      'Real-time dark-web / leak-site monitoring posts. Volume is high — best filtered for keywords matching your threat profile.',
  },
  {
    id: 'ddosecrets',
    name: 'Distributed Denial of Secrets',
    handle: 'DDoSecrets',
    attribution: 'ddosecrets.com',
    categories: ['breach-leaks', 'threat-intel'],
    language: 'en',
    audience: 'public-channel',
    description:
      'Journalist-collective publishing redacted leak datasets in the public interest. Source for verified-provenance breach data.',
    badge: 'research',
  },
  ...
  },
  {
    ...
    handle: 'security_weekly',
    categories: ['security-news'],
    language: 'en',
    audience: 'public-channel',
    description: 'Generic security-news aggregator channel; useful as a low-effort awareness feed.',
  },
  {
    id: 'cybersecnews',
    name: 'Cyber Security News',
    handle: 'cybersecuritynws',
    categories: ['security-news'],
    language: 'en',
    audience: 'public-channel',
    description: 'High-volume aggregator — mirrors dozens of security news sources into one channel.',
  },
  {
    id: 'krebsonsecurity',
    name: 'Krebs on Security (mirror)',
    handle: 'krebsonsecurity',
    attribution: 'community-run mirror of krebsonsecurity.com',
    categories: ['security-news'],
    language: 'en',
    audience: 'public-channel',
    description: 'Community-run mirror of Brian Krebs blog posts. Verify against the canonical site before quoting.',
  },
  ...
  {
    id: 'osintfounder',
    name: 'The OSINT Founder',
    handle: 'osintfounder',
    attribution: 'OSINT Founder',
    categories: ['osint-research'],
    language: 'en',
    audience: 'public-channel',
    description:
      'Investigation tradecraft, geolocation puzzles, and OSINT tooling write-ups. Useful skill-building feed.',
    badge: 'research',
  },
  {
    id: 'osinttechnical',
    name: 'OSINT Techniques',
    handle: 'osinttechniques',
    attribution: 'osinttechniques.com',
    categories: ['osint-research'],
    language: 'en',
    audience: 'public-channel',
    description: 'Companion to osinttechniques.com — investigation methodology, tool releases, case studies.',
  },
  {
    id: 'bellingcat',
    name: 'Bellingcat',
    handle: 'bellingcat',
    attribution: 'bellingcat.com',
    categories: ['osint-research'],
    language: 'en',
    audience: 'public-channel',
    description: 'Investigative-journalism collective — long-form OSINT case studies (conflict, war crimes, fraud).',
    badge: 'essential',
  },
  {
    id: 'intelcrab',
    name: 'IntelCrab',
    handle: 'IntelCrab',
    attribution: 'IntelCrab OSINT',
    categories: ['osint-research', 'threat-intel'],
    language: 'en',
    audience: 'public-channel',
    description: 'Conflict + cyber OSINT crossover. Strong on geopolitical-cyber intersections.',
  },
  ...
  // ─────────────────────────────────────────────────────────────────────
  // Vendor / community feeds
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'cisaalerts',
    name: 'CISA Alerts (community mirror)',
    handle: 'cisa_alerts',
    attribution: 'community-run mirror of CISA RSS',
    categories: ['security-news', 'threat-intel'],
    language: 'en',
    audience: 'public-channel',
    description:
      'Community mirror of CISA bulletins. For the canonical source use cisa.gov/news-events/cybersecurity-advisories.',
  },
  {
    id: 'cve-feed',
    name: 'CVE feed',
    ...
    language: 'en',
    audience: 'public-channel',
    description: 'Real-time CVE publication ticker — high-volume; pair with /dfir/cve for triage.',
  },
];
